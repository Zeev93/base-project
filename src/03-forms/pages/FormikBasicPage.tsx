  ...
  return (
    <div>
        ...
        <form noValidate onSubmit={handleSubmit}> 
            ...
            { touched.firstName && errors.firstName && <span> {errors.firstName} is required </span> }

            <label htmlFor="lastName">Last Name</label>
            <input type="text" name="lastName" onBlur={handleBlur} onChange={ handleChange } value={values.lastName} />
            { touched.lastName && errors.lastName && <span> {errors.lastName} is required </span> }
            
            <label htmlFor="email">Email Address</label>
            <input type="text" name="email" onBlur={handleBlur} onChange={ handleChange } value={values.email} />
            { touched.email && errors.email && <span> {errors.email} is required </span> }
